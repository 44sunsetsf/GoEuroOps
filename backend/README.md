...
GoEuroOps 是一个面向客服/运营场景的多 Agent 智能系统。它不是单纯的聊天机器人，而是把以下能力串成闭环：
...
```bash
docker compose logs -f goeuroops
```
...
- [GoEuroOps定位与技术亮点](wiki/GoEuroOps定位与技术亮点.md)
- [技术亮点](wiki/技术亮点.md)
- [重点代码](wiki/重点代码.md)

## 一句话概括

GoEuroOps 是一个可观测、可评测、可降级的多 Agent 客服运行时。
