...
- 样本 380 条，19 类；模型 `deepseek-v4-pro`；向量路 `bge`；运行于 2026-09-24T11:14:23，耗时 87.6 秒
- LLM 调用失败 0 次；LLM 单次延迟 p50 1384 ms，p95 1727 ms
- 分歧检测触发 0 次
...
|---|---|---|---|
| 三路融合（v3.1，线上） | 91.8% | 0.917 | 94.0% |
| 三路融合（v3.0，修复前） | 91.6% | 0.914 | 93.7% |
| 仅 LLM | 91.8% | 0.917 | 94.0% |
...
|---|---|---|---|---|
| query | 0.92 | 0.55 | 0.69 | 20 |
| escalation | 1.00 | 0.60 | 0.75 | 20 |
| service_inquiry | 0.65 | 1.00 | 0.78 | 20 |
...
| 我要找你们老板 | escalation | human_handoff | human_handoff | 0.77 |
...
| 请上报给你们合伙人 | escalation | human_handoff | human_handoff | 0.80 |
| 我需要你们给一个正式的书面答复 | escalation | human_handoff | human_handoff | 0.76 |
...
| MBA申请你们接吗 | other | service_inquiry | service_inquiry | 0.79 |
