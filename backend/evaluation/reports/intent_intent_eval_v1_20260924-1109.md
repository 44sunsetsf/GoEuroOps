...
- 样本 380 条，19 类；模型 `deepseek-v4-pro`；向量路 `bge`；运行于 2026-09-24T11:09:43，耗时 91.7 秒
- LLM 调用失败 0 次；LLM 单次延迟 p50 1444 ms，p95 1773 ms
- 分歧检测触发 0 次
...
|---|---|---|---|
| 三路融合（v3.1，线上） | 91.6% | 0.914 | 93.7% |
| 三路融合（v3.0，修复前） | 91.3% | 0.911 | 93.4% |
| 仅 LLM | 91.6% | 0.914 | 93.7% |
...
| escalation | 1.00 | 0.60 | 0.75 | 20 |
| service_inquiry | 0.62 | 1.00 | 0.77 | 20 |
| human_handoff | 0.69 | 1.00 | 0.82 | 20 |
| request | 0.94 | 0.80 | 0.86 | 20 |
...
| service_progress | 0.95 | 0.95 | 0.95 | 20 |
...
| 你们一般用什么软件开会 | query | service_inquiry | service_inquiry | 0.63 |
| 你们只做计算机方向吗 | query | service_inquiry | service_inquiry | 0.82 |
| 你们一年带多少学生 | query | service_inquiry | service_inquiry | 0.64 |
| 你们是正规公司吗 | query | service_inquiry | service_inquiry | 0.64 |
| 怎么称呼你 | query | greeting | greeting | 0.63 |
| 你是真人还是机器人 | query | human_handoff | human_handoff | 0.85 |
...
| 请把文书的批注版也发我 | request | service_progress | service_progress | 0.63 |
| 麻烦把推荐信模板发我 | request | application_process | application_process | 0.64 |
| 有人在线吗 | greeting | human_handoff | human_handoff | 0.63 |
| 我要找你们老板 | escalation | human_handoff | human_handoff | 0.79 |
| 把你们负责人叫来 | escalation | human_handoff | human_handoff | 0.90 |
| 这个问题我要直接和创始人谈 | escalation | human_handoff | human_handoff | 0.92 |
| 找个能做主的人来 | escalation | human_handoff | human_handoff | 0.80 |
| 请上报给你们合伙人 | escalation | human_handoff | human_handoff | 0.79 |
